      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.status == 'success') {
            $('#total_dosen').html(data.total_dosen);
            $('#dosen_aktif').html(data.dosen_aktif);
            $('#dosen_nonaktif').html(data.dosen_nonaktif);
          } else {
