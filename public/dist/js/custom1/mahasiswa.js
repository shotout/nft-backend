      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.status == 'success') {
            $('#total_mahasiswa').html(data.total_mahasiswa);
            $('#mahasiswa_aktif').html(data.mahasiswa_aktif);
            $('#mahasiswa_nonaktif').html(data.mahasiswa_nonaktif);
          } else {
