...
<html lang="en">
    <head>
        ...
        <title>NFT Daily App - Email Verification</title>
    </head>
    <body>
                    ...
                    <tr>
                        ...
                        <div role="banner">
                            ...
                            <div style="border-collapse:collapse;display:table;width:100%">
                                ...
                                <p style="Margin-top:0;Margin-bottom:0">NFT Daily App - Email Verification</p>
                                </div>
                        ...
                        <div role="section">
                            ...
                            <div style="Margin:0 auto;max-width:600px;min-width:320px;width:320px;width:calc(28000% - 167400px);word-wrap:break-word;word-break:break-word">
                                ...
                                <div style="max-width:600px;min-width:320px;width:320px;width:calc(28000% - 167400px);text-align:left;color:#111324;font-size:16px;line-height:24px;font-family:sans-serif">
                                    ...
                                    <div style="Margin-left:20px;Margin-right:20px">
                                    <div>
                                        <h1 style="Margin-top:0;Margin-bottom:20px;font-style:normal;font-weight:normal;color:#111324;font-size:22px;line-height:31px;text-align:left">Thank you for registering at NFT Daily App</h1>
                                    </div>
                                    </div>
                                    <div style="Margin-left:20px;Margin-right:20px">
                                    <div>
