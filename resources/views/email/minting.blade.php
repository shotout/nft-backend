                                            ...
                                            <div style="max-width:600px;min-width:320px;width:320px;width:calc(28000% - 167400px);text-align:left;color:#111324;font-size:16px;line-height:24px;font-family:sans-serif">
                                                ...
                                                <div style="Margin-left:10px;Margin-right:30px; margin-bottom:30px;">
                                                    <div style="margin-bottom:0px; border: 1px solid gray; border-radius: 15px; margin-left:3px; overflow: hidden;">
                                                        <div>
                                                            <a href="{{$product->nft_mint}}" target="_blank" style="width: 100px; height: 100px; border-radius: 30px; margin-left: 15px; margin-right: 10px; margin-bottom: 10px; float: left; padding-bottom: 10px;"><img src="{{'https://backend.nftdaily.app/'.$product->collections[0]->image}}"></a>

                                                            <h4 style=" font-size: 16px; font-weight: 700; fill: #FFFFFF; text-align: center; margin-top: 20px; margin-bottom: 5px;"><a href="{{$product->nft_mint}}" target="_blank"> {{$product->nft_title}}</a> </h4>
                                                            <form action = "{{$product->nft_mint}}" target="_blank">
                                                                <button style=" background-color: #29AAE1; color: #ffffff; font-size: 16px; fill: #FFFFFF; line-height: 26.55px; padding: 3px 150px; text-align: center;  margin-top: 15px; margin-left: 20px; margin-bottom: 10px; display: inline-block; border-radius: 7px;" type="submit"> MINT NOW </button>
                                                            </form>
