...
<div class="col-sm-12" id="add-item-container">
  <div class="card user-list">
      <div class="card-header">
        <h5><a href="{{ url('wallet/list') }}">{{ __('Wallet') }}</a> >> {{ $walletData->name }} >> {{ __('Update Wallet Data') }}</h5>
    ...
    <div class="card-block">
      ...
      <form id="itemAddForm" class="form-horizontal" action="{{ url('wallet/update') }}" method="post" enctype="multipart/form-data">
        <input type="hidden" value="{{ csrf_token() }}" name="_token" id="token">
        <input type="hidden" value="{{ $walletData->id }}" name="wallet_id" id="wallet_id">
              ...
              <div class="col-md-8">
                <div class="form-group row ">
                  ...
                  <div class="col-sm-8 pl-sm-3-custom">
                    <input type="text" class="form-control" placeholder="{{ __('Wallet Name')  }}" name="wallet_name" id="Wallet Name" value="{{ $walletData->name }}">
