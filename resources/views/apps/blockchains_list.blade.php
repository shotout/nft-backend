...
@section('list-title')
  <h5><a href="{{ url('wallet/list') }}">{{ __('Blockchains List') }}</a></h5>
@endsection
...
@include('sweetalert::alert')
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 m-l-10 m-b-0">
    <div class="buttonRelation mt-3">      
      <a href="{{ url('blockchain/create') }}" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-plus"> &nbsp;</span>Add New Blockchains</a>
    </div>
  </div>
