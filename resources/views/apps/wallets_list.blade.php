...
@section('list-title')
  <h5><a href="{{ url('wallet/list') }}">{{ __('Wallets List') }}</a></h5>
@endsection
...
@include('sweetalert::alert')
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 m-l-10 m-b-0">
    <div class="buttonRelation mt-3">      
      <a href="{{ url('wallet/create') }}" class="btn btn-outline-primary custom-btn-small"><span class="fa fa-plus"> &nbsp;</span>Add New Wallet</a>
    </div>
  </div>
