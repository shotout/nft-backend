...
<div class="col-sm-12" id="add-item-container">
  <div class="card user-list">
    ...
    <div class="card-block">
      ...
      <form id="itemAddForm" class="form-horizontal" action="{{ url('faq/update') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-8">
                <div class="form-group row ">
                  ...
                  <div class="col-sm-10 pl-sm-3-custom">
                    <textarea type="text" class="form-control" placeholder="{{ __('Question')  }}" name="faq_question" id="faq_question" rows = "3">{{ $faq->question }}</textarea>
