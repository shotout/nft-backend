          ...
          <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="form-group row ">
                  <label class="col-sm-2 control-label require">{{ __('Owner') }}</label>
                  <div class="col-sm-4 pl-sm-3-custom">
                    <input type="number" class="form-control" placeholder="{{ __('NFT Owner')  }}" name="nft_amount" id="nft_amount" value="{{ old('nft_amount') }}">
                    <span id="checkMsg" class="text-danger"></span>
                  </div>
                ...
                <div class="form-group row ">
                  ...
                  <div class="col-sm-4 pl-sm-3-custom">
                    <input type="text" class="form-control" placeholder="{{ __('NFT Mint')  }}" name="nft_amount" id="nft_amount" value="{{ old('nft_amount') }}">
                    <span id="checkMsg" class="text-danger"></span>
                  </div>
                  <label class="col-sm-1 control-label require ">{{ __('Wallet') }}</label>
                  <div class="col-sm-4 pl-sm-3-custom ">
                        <select class="js-example-basic-single form-control" id="status1" name="magang_pembimbing1">
